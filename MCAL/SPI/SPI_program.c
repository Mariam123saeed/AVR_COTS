...
/**********************************************************************************************************************************************/
void SPI_voidTrancieveData (u8 copy_u8TxData ,u8 *copy_pu8RxData)
{
	u8 local_u8ErrorStatus = TRUE;
	...
	if (copy_pu8RxData != NULL)
	{
			...
			/* Wait for transmission complete */
			while (0 == GET_BIT (SPSR_REG,SPIF));
			/*Recieve data from SPI_data register*/
			*copy_pu8RxData = SPDR_REG ;
	}
	else
	{
...
/**********************************************************************************************************************************************/
void SPI_u8TranceiveAsynch(u8 copy_u8TxData, u8 *copy_pu8RxData, void (*copy_NotificationFunc)(void))
{
